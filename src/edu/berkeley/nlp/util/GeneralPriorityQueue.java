...
public class GeneralPriorityQueue<E>  {
  ...
  /**
   * An <code>Entry</code> stores an object in the queue along with its current location (array position) and priority.
  ...
  /**
   * On the assumption that leftChild(entry) and rightChild(entry) satisfy the heap property, make sure that the heap at
   * entry satisfies this property by possibly percolating the element o downwards.  I've replaced the obvious recursive
