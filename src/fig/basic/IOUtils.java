...
public class IOUtils {
	...
	public static List<File> getFilesUnder(String path, String prefix, String extension) {
		return getFilesUnder(path, prefix, extension, true);
	}
